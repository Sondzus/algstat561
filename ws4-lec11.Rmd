...
$$
Unlike the MLE on hw3, this one is easier to derive. Use the formulation above and calculus (yes, take partial derivatives by hand) to derive the MLEs $\hat\pi_{ij},\hat\alpha_{ij},\hat\beta_{jk}$ written in equation 1.1.4 in the book. 
